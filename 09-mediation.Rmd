...
```{r mediation-multipleregression, fig.cap="How do regression coefficients change if new predictors are added to the model? The gray dots and lines represent the simple regression coefficients and their 95% confidence intervals in a model predicting nespaper reading time. Blue dots and lines represent results in a regression model including all selected predictors.", echo=FALSE, screenshot.opts = list(delay = 5), dev="png", out.width="530px"}
