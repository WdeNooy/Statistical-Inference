...
```{r mediation-inference, fig.cap="Does the sampling distribution of an indirect effect resemble the sampling distributions of its direct effects?", echo=FALSE, out.width="775px", screenshot.opts = list(delay = 5), dev="png"}
