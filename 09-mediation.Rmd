...
2. How do the numbers tell you that the effect of political interest on newspaper reading time is controlled for age? Hint: Compare standardized regression coefficients to the correlations.
...
6. Change the correlations in such a way that the effect of political interest on reading time is completely spurious if age would be excluded from the model.

7. Can the standardized effect of political interest on reading time be larger than 1.0 or smaller than -1.0? If so, in which situation? If not, why not? Use the sliders to check your answer.
...
```{r eval=FALSE}
1. Age is the strongest confounder in this example. If we 
...
2. Why is the standardized effect of political interest on newspaper reading time not always equal to the correlation between these two variables? When is this standardized effect equal to the correlation? Use the sliders to check your answer.

3. When does political interest have no (standardized) effect on reading time in this model? Use the sliders to check your answer.

4. Change the correlations in such a way that the partial effect of political interest on reading time is larger than the correlation between the two variables. In this situation, would political interest be a suppressor or reinforcer if it would be excluded from the model?

5. Can the standardized effect of political interest on reading time be larger than 1.0 or smaller than -1.0? If so, in which situation? If not, why not?
