...
```{block2, type='rmdquestion'}
3. Interpret the meaning of the regression coeficients in the simple regression models (the values indicated by the gray dots). In which situation are the gray and blue results equal? [<img src="icons/2answer.png" width=115px align="right">](#answer9.1.3)
```
...
* A simple regression model contains only one independent variable. The regression coefficient represents the effect of this independent variable without controlling for the effects of other independent variables.
* These effects are positive for age and political interest in the example: Older people and people who are more interested in politics are predicted to spend more time on reading newspapers. The effects are negative for education and news site use: People with more (years of) education or more frequently using news sites are predicted to spend less time on reading newspapers.
* If we select only one independent variable, we have a simple regression model, so the independent variable's blue effect must be equal to its gray effect. [<img src="icons/2question.png" width=161px align="right">](#question9.1.3)
```
...
```{block2, type='rmdimportant'}
A variable is a suppressor (1) if it is not included in the regression model and (2) it establishes an indirect correlation between predictor and independent variable that has the opposite sign of the current effect of the predictor on the independent variable.
```
...
```{block2, type='rmdimportant'}
A variable is a reinforcer (1) if it is not included in the regression model and (2) it establishes an indirect correlation between predictor and independent variable that has the same sign as the current effect of the predictor on the independent variable.
```
...
<table style="font-size: 0.8em">
  <tr align="center">
    ...
    <td colspan=2 style="border-top: 1px solid; border-bottom: 1px solid; ">
      95% CI for <i>B</i>
    </td>
    <td style="border-top: 1px solid">
      <i>SE B</i>
  ...
  <tr>
    <td>Step 1</td><td colspan="5"></td><td align="right">.01</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">46.21***</td><td align="right">35.14</td><td align="right">57.28</td><td align="right">5.63</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;Education (in years)</td><td align="right" style="border-bottom: 1px solid">-0.86*&nbsp;&nbsp;&nbsp;</td><td align="right" style="border-bottom: 1px solid">-1.66</td><td align="right" style="border-bottom: 1px solid">-0.05</td><td align="right" style="border-bottom: 1px solid">0.41</td><td align="right" style="border-bottom: 1px solid">-0.12*&nbsp;&nbsp;&nbsp;</td><td style="border-bottom: 1px solid"></td>
  </tr>
  <tr>
    <td>Step 2</td><td colspan="5"></td><td align="right">.05</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">43.74***</td><td align="right">32.75</td><td align="right">54.74</td><td align="right">5.59</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">-1.25** &nbsp;</td><td align="right">-2.07</td><td align="right">-0.42</td><td align="right">0.42</td><td align="right">-0.17** &nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;Interest in politics</td><td align="right" style="border-bottom: 1px solid">1.51** &nbsp;</td><td align="right" style="border-bottom: 1px solid">0.61</td><td align="right" style="border-bottom: 1px solid">2.41</td><td align="right" style="border-bottom: 1px solid">0.46</td><td align="right" style="border-bottom: 1px solid">0.19** &nbsp;</td><td style="border-bottom: 1px solid"></td>
  </tr>
  <tr>
    <td>Step 3</td><td colspan="5"></td><td align="right">.73</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">45.74***</td><td align="right">39.85</td><td align="right">51.63</td><td align="right">2.99</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">0.16 &nbsp;&nbsp;&nbsp;</td><td align="right">-0.29</td><td align="right">0.62</td><td align="right">0.23</td><td align="right">0.02 &nbsp;&nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Interest in politics</td><td align="right">1.13*** </td><td align="right">0.65</td><td align="right">1.61</td><td align="right">0.25</td><td align="right">0.14***</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;News sites use</td><td align="right" style="border-bottom: 1px solid">-5.72***</td><td align="right" style="border-bottom: 1px solid">-6.12</td><td align="right" style="border-bottom: 1px solid">-5.31</td><td align="right" style="border-bottom: 1px solid">0.21</td><td align="right" style="border-bottom: 1px solid">-0.85***</td><td style="border-bottom: 1px solid"></td>
  </tr>
  <tr>
    <td>Step 4</td><td colspan="5"></td><td align="right">.79</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">13.59***</td><td align="right">5.26</td><td align="right">21.93</td><td align="right">4.24</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">0.06 &nbsp;&nbsp;&nbsp;</td><td align="right">-0.34</td><td align="right">0.46</td><td align="right">0.20</td><td align="right">0.01 &nbsp;&nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Interest in politics</td><td align="right">0.52* &nbsp;&nbsp;</td><td align="right">0.07</td><td align="right">0.96</td><td align="right">0.23</td><td align="right">0.07* &nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;News sites use</td><td align="right">-1.55** &nbsp;</td><td align="right">-2.47</td><td align="right">-0.64</td><td align="right">0.47</td><td align="right">-0.23** &nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;Age (in decades)</td><td align="right" style="border-bottom: 1px solid">4.55***</td><td align="right" style="border-bottom: 1px solid">3.62</td><td align="right" style="border-bottom: 1px solid">5.47</td><td align="right" style="border-bottom: 1px solid">0.47</td><td align="right" style="border-bottom: 1px solid">0.67***</td><td style="border-bottom: 1px solid"></td>
  </tr>
</table>
...
<table style="font-size: 0.8em">
  ...
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">60.98***</td><td align="right">47.05</td><td align="right">74.91</td><td align="right">7.08</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">-1.30** &nbsp;</td><td align="right">-2.14</td><td align="right">-0.46</td><td align="right">0.43</td><td align="right">-0.18** &nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;Political cynicism</td><td align="right" style="border-bottom: 1px solid">-1.68** &nbsp;</td><td align="right" style="border-bottom: 1px solid">-2.67</td><td align="right" style="border-bottom: 1px solid">-0.69</td><td align="right" style="border-bottom: 1px solid">0.50</td><td align="right" style="border-bottom: 1px solid">-0.20** &nbsp;</td><td style="border-bottom: 1px solid"></td>
  </tr>
  <tr>
    <td>Step 3</td><td colspan="5"></td><td align="right">.72</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">53.65***</td><td align="right">46.00</td><td align="right">61.31</td><td align="right">3.89</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">0.27&nbsp;&nbsp;&nbsp;</td><td align="right">-0.21</td><td align="right">0.74</td><td align="right">0.24</td><td align="right">0.04 &nbsp;&nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Political cynicism</td><td align="right">-0.69* &nbsp;&nbsp;</td><td align="right">-1.24</td><td align="right">-0.14</td><td align="right">0.28</td><td align="right">-0.08* &nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;News sites use</td><td align="right" style="border-bottom: 1px solid">-5.70***</td><td align="right" style="border-bottom: 1px solid">-6.12</td><td align="right" style="border-bottom: 1px solid">-5.28</td><td align="right" style="border-bottom: 1px solid">0.21</td><td align="right" style="border-bottom: 1px solid">-0.84***</td><td style="border-bottom: 1px solid"></td>
  </tr>
  <tr>
    <td>Step 4</td><td colspan="5"></td><td align="right">.79</td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Constant</td><td align="right" style="text-align: right">15.45***</td><td align="right">5.65</td><td align="right">25.26</td><td align="right">4.98</td><td colspan="2"></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Education (in years)</td><td align="right">0.10 &nbsp;&nbsp;&nbsp;</td><td align="right">-0.31</td><td align="right">0.51</td><td align="right">0.21</td><td align="right">0.01 &nbsp;&nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;Political cynicism</td><td align="right">-0.30 &nbsp;&nbsp;&nbsp;</td><td align="right">-0.78</td><td align="right">0.18</td><td align="right">0.24</td><td align="right">-0.03 &nbsp;&nbsp;&nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left">&nbsp;&nbsp;News sites use</td><td align="right">-1.35** &nbsp;</td><td align="right">-2.25</td><td align="right">-0.45</td><td align="right">0.46</td><td align="right">-0.20** &nbsp;</td><td></td>
  </tr>
  <tr>
    <td align="left" style="border-bottom: 1px solid">&nbsp;&nbsp;Age (in decades)</td><td align="right" style="border-bottom: 1px solid">4.76***</td><td align="right" style="border-bottom: 1px solid">3.86</td><td align="right" style="border-bottom: 1px solid">5.67</td><td align="right" style="border-bottom: 1px solid">0.46</td><td align="right" style="border-bottom: 1px solid">0.70***</td><td style="border-bottom: 1px solid"></td>
  </tr>
</table>
<div style="font-size: 0.8em">
  <i>Note.</i> CI = confidence interval; <i>LL</i> = lower limit; <i>UL</i> = upper limit; <i>B</i>* = standardized regression coefficient.
