...
knitr::kable(results, digits = 3, booktabs = TRUE,
  ...
  footnote(alphabet = c(paste0("Equation for non-smokers: y = ", report_n(model_1$coefficients[2],3), " * Exposure	+ ", report_n(round(model_1$coefficients[1],3) + (round(model_1$coefficients[4],3) * round(mean(smokers$contact), 3)), 3) ,"."), paste0("Equation for smokers: y = ", report_n(round(model_1$coefficients[2],3) + round(model_1$coefficients[5],3), 3), " * Exposure	+ ", report_n(round(model_1$coefficients[1],3) + round(model_1$coefficients[3],3) + (round(model_1$coefficients[4],3) * round(mean(smokers$contact), 3)), 3), ".")))
# Cleanup.
