...
```{block2, type='rmdquestion'}
2. Figure \@ref(fig:nullsampling) shows the hypothesized population mean and the associated sampling distribution. Formulate the null hypothesis represented by this figure and explain whythe hypothesized value is in the middle of the sampling distribution. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.2)
```
...
```{block2, type='rmdquestion'}
4. In the second step of hypothesis testing (click on *Step 2*), we have to formulate a decision rule: When are we going to reject the null hypothesis? The decision rule is customarily based on a significance level of five per cent. When do we reject the null hypothesis? What represents the *rejection region* in Figure \@ref(fig:nullsampling)? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.4)
```
