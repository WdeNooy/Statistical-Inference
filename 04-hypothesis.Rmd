...
# Interpret results. Including reporting analysis of variance results?
```
...
2. How well can we predict brand awareness with ad exposure, having heard through word of mouth, and consumer's sex?
...
Ad exposure, having heard through word of mouth, and 
consumer sex help to predict about a quarter of the 
variation in brand awareness scores, R2 = .28, 
F (3, 58) = 7.51, p < .001.
The predictive effect of exposure to brand advertisements 
is moderately strong (b* = 0.42). An additional
unit of exposure increases the predicted brand awareness
with 0.4 points, t = 3.72, p < .001, 95%[0.19; 0.63].
Word of mouth, against expectations, reduces brand 
awareness. People with word of mouth information have on
average 1 point less brand awareness, t = -2.37, p = .021, 
95%CI[-1.83; -0.15] if we control for exposure.
Finally, there is hardly a difference between females and
males, t = -0.75, p = .456, 95%CI[-1.04; 0.47]. Males
have on average 0.28 points less brand awareness than 
females.
```
...
3. Is there a fixed relation between the t values and the values for average sample media literacy? Change the sample size to find the answer.

4. What is the relation between sample size in critical t values?
