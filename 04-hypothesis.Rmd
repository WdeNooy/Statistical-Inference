...
We have to reject the null hypothesis that the TV station does not reach at least fourty per cent of all households, p = .039 (one-sided).  
```
...
There are no assumptions for the chi-squared test.  
