...
3. Why does the distribution become more pointed when sample size increa
...
3. Use the slider to find the 95% confidence interval for the population mean given the sample mean.

4. How does the 95% confidence interval for the population mean relate to the null hypotheses that are not rejected?
