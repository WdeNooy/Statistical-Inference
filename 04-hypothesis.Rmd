...
In the sample, average parental supervision is 5.36 (SD = 1.94) 
on a scale from 1 to 10. in theWe are rather confident that the 
true average supervision score in the population is around 5.5, 
more specifically, between 4.94 and 5.77, t (85) = -0.68, 
p = .498, 95%CI[4.94; 5.77].
...
```{r eval=FALSE, echo=TRUE}
* It is the probability of drawing a sample with average media literacy scores
