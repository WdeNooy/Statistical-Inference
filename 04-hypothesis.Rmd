...
```{block2, type='rmdquestion'}
6.  Go to Step 3 in the figure, which adds the sample. Is the test statistically significant for this sample? Explain your answer.  

Take some more samples to practice recognizing statistically significant results.[<img src="icons/2answer.png" width=115px align="right">](#answer4.2.6)
```
...
```{r onetwosided, fig.cap="Halve a two-sided p value to obtain a one-sided p value, double a one-sided p value to obtain a two-sided p value.", echo=FALSE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
...
# Let the user manipulate the population mean according to the null hypothesis (range 1-10) and allow her to draw a new sample.
knitr::include_app("http://82.196.4.233:3838/apps/onetwosided/", height="400px")
```
