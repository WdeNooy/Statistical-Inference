...
<table><tr><td>
```{r random-variable, fig.cap="Number of yellow candies in a sample as random variable.", echo=FALSE, out.width="420px"}
...
Figure \@ref(fig:random-variable) shows a population of candies. The button allows you to draw a random sample of ten candies from this population. Try to answer the folowing questions before you press the button.  
...
Figure \@ref(fig:sampling-distribution) displays the population of candies (candy factory's stock, top), a random sample from this population (one bag, middle), and the sampling distribution (bottom). Draw one random sample.
...
<table><tr><td>
```{r expected-value, echo=FALSE, out.width="420px", fig.cap="Expected value of a probability distribution."}
...
```{r p-values, fig.cap="p Values in a normal sampling distribution.", echo=FALSE}
