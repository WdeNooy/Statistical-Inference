...
```{r random-variable, fig.cap="Number of yellow candies in a sample as random variable."}
...
```{r sampling-distribution, fig.cap="From population to samples to sampling distribution."}
