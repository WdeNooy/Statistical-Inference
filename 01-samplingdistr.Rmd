...
knitr::include_url("https://www.youtube.com/embed/kcr7EbB2Alg", height = "360px")
```
...
```{r sampling-distribution, fig.cap="What is a sampling distribution?", echo=FALSE, screenshot.opts = list(delay = 5), dev="png", out.width="775px"}
...
* In the two graphs to the left, candies are the cases. A candy has a particular
colour, not a (sample) bag of candies.
* In the right-hand graph showing the sampling distribution, samples (candy bags)
...
```{r sampling-distribution-summary1, echo=FALSE, fig.cap="A discrete sampling distribution.", screenshot.opts = list(delay = 5), dev="png", out.width="775px"}
...
* The numbers on the horizontal axis of the bottom-right histogram represent the
