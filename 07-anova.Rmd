...
group (or, from some point, closer to the bottom group).
```
...
arrows (within-groups differences) yields the within-groups variance.
```
...
group means, which is called the between-groups variance.
```
...
root of the variance to obtain the overall standard deviation.
```
