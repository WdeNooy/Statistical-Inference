...
* The test result for every effect, consisting of the test name (_F_), the degrees of freedom, and the significance (p value). APA6 prescribes the following format if you report the test result within your text: _F) (_df1_, _df2_) = F value, _p_ = p value. Note that _df1) is the degrees of freedom of the factor and _df2_ is the degrees of freedom of the error (within-groups).
