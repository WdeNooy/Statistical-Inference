...
```{r anova-overview, echo=FALSE, fig.cap="Main effects and interaction effect in two-way analysis of variance.", screenshot.opts = list(delay = 5), dev="png", out.width="420px"}
