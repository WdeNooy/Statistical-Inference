...
1. Use the data in <a href="http://82.196.4.233:3838/data/donors.sav" target="_blank">donors.sav</a> to test if celebrity endorsement for a fund raiser affects willingness to donate. Check the assumptions and interpret the results. Create a plot to communicate your results.
...
2. How does celebrity endorsement affect the willingness to donate and is one celebrity more effective than the other?  
...
1. Use the data in <a href="http://82.196.4.233:3838/data/donors.sav" target="_blank">donors.sav</a> to test if the effect of celebrity endorsement on willingness to donate differs for females and males. Check the assumptions and interpret the results. Create a plot to communicate your results.
...
2. Use the same data as in Exercise 1 to test if the effect of celebrity endorsement on willingness to donate depends on remembrance of the campaign. Check the assumptions and interpret the results. Create a plot to communicate your results.
