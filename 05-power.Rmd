...
Effect size is also zero according to the standard null hypotheses used for tests on the regression coefficient (_b_), _R_^2^ for the regression model, and eta^2^ for analysis of variance. As a result, we can use the standardized regression coefficient (Beta in SPSS and _b_* according to APA), _R_^2^, and eta^2^ as standardized effect sizes.
