...
```{r eval=FALSE}
* The red area represents the significance level of the null hypothesis test,
namely the total probability of rejecting the null hypothesis if it is true.
* The yellow are gives the probability that we draw a sample from a population
...
```{r eval=FALSE}
* A higher significance level, for example, 10% instead 5%, has the same effect
