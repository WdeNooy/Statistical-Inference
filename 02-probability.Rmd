...
Watch this micro lecture on probablity models for an overview of the chapter.
...
knitr::include_url("https://www.youtube.com/embed/m1XaYrkYHh8", height = "360px")
...
Levene's test on homogeneity of variances is not statistically  
...
```{r normal-approximation, echo=FALSE, fig.cap="Normal curve as theoretical approximation of a sampling distribution.", screenshot.opts = list(delay = 5), dev="png", out.width="420px"}
...
```{r normal-approx-proportion, fig.cap="How does the shape of the sampling distribution of sample proportions change with sample size and proportion value?", echo = FALSE, screenshot.opts = list(delay = 5), dev="png", out.width="775px"}
...
```{r decisionscheme, echo=FALSE, fig.cap="Diagram for selecting the type of sampling distribution.", out.width="775px"}
