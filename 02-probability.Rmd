...
Median candy weight in the sample is 2.81 grams. With   
...
There is a moderate association (Cramer's V = .27) between candy colour and candy spottiness, which is not statistically significant, *p* = .480 (exact) or (using chi-square) *p* = .555.   
