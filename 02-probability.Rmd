...
In Section 2.3 Figure \@ref(@), we will learn that we should use the exact p value instead of the default asymptotic p value in a table such as the current one because of the low expected cell values.
