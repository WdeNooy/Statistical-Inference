...
There is a moderate association (Cramer's V = .27) between candy colour and candy stickiness, which is   
not statistically significant, *p* = .480 (exact) or  *p* = .555 (exact).   
