...
1. What is the null hypothesis in Figure \@ref(fig:tiny-effects) and how can you tell?
...
as it's mean (as its expected value).
```
...
This approach is so prevalent that null hypotheses equating the population value of interest to zero have received a special name: the _nil hypothesis_ or _the nil_ for short (see Section \@ref(nil)). How can we include previous knowledge in our test if the software always tests the nil?  
