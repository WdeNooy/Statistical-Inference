...
knitr::include_url("https://www.youtube.com/embed/ddv8iQvQVlE", height = "360px")
```
...
```{r pdance, echo=FALSE, out.width="640px", dev="png", fig.cap="The dance of the p values by Geoff Cumming.", screenshot.opts = list(delay = 5)}
