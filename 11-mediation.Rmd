...
```{r mediation-regression, echo=FALSE, fig.pos='H', fig.align='center', fig.cap="Path diagram with unstandardized effect sizes and their 95% confidence intervals.", screenshot.alt = "figures/mediation-regression.png"}
...
```{r pathdiagram-unstandardized, echo=FALSE, fig.pos='H', fig.align='center', fig.cap="Path diagram with unstandardized effect sizes and their 95% confidence intervals.", screenshot.alt = "figures/pathdiagram-unstandardized.png"}
