...
```{r mediation-multipleregression, fig.cap="How do regression coefficients change if new predictors are added to the model? The light dots and lines represent the simple regression coefficients and their 95% confidence intervals. Dark dots and lines represent results in a regression model including all selected predictors.", echo=FALSE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
...
```{r resid-normal, fig.cap="What are the residuals and how are they distributed?", echo=FALSE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
...
knitr::include_app("http://82.196.4.233:3838/apps/resid-normal/", height="485px")
```
...
```{r common-support, fig.cap="Common support for the exposure predictor in each category of smoking status.", echo=FALSE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
...
knitr::include_app("http://82.196.4.233:3838/apps/common-support/", height="565px")
```
...
```{r continuous-interaction-visualization, fig.cap="Which moderator values are helpful for visualizing moderation?", echo=FALSE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
