...
```{r ci-borders, fig.cap="Within which interval do we find the sample results that are closest to the population value?", echo=TRUE, out.width="420px", screenshot.opts = list(delay = 5), dev="png"}
