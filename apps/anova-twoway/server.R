    ...
    if ("1" %in% input$groupselect & length(input$groupselect) == 1)
      ...
      p <-
        ...
        geom_segment( x    = min(subset(df, cat1 == "Clooney")$x - .09),
                      ...
                      size = 1.2,
                      aes(colour = "Clooney",linetype = "Clooney")) +
        geom_segment( x    = min(subset(df, cat1 == "Jolie")$x - .09),
                      ...
                      size = 1.2,
                      aes(colour = "Jolie",linetype = "Jolie")) +
        geom_segment( x    = min(subset(df, cat1 == "NoEnd")$x - .09),
                      xend = max(subset(df, cat1 == "NoEnd")$x + .09),
                      y    = mean(subset(df, cat1 == "NoEnd")$y),
                      yend = mean(subset(df, cat1 == "NoEnd")$y),
                      size = 1.2,
                      aes(colour = "No Endorser",linetype = "No Endorser"))  +
