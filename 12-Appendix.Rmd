...
```{r SPSSLevene, echo=FALSE, out.width="640px", fig.cap="(ref:SPSSLevene)", dev="png", screenshot.opts = list(delay = 5)}
...
```{r SPSSTindep, echo=FALSE, out.width="640px", fig.cap="(ref:SPSSTindep)", dev="png", screenshot.opts = list(delay = 5)}
...
```{r SPSSTpaired, echo=FALSE, out.width="640px", fig.cap="(ref:SPSSTpaired)", dev="png", screenshot.opts = list(delay = 5)}
...
```{r SPSScorrelation, echo=FALSE, out.width="640px", fig.cap="(ref:SPSScorrelation)", dev="png", screenshot.opts = list(delay = 5)}
...
```{r SPSSchisqcross, echo=FALSE, out.width="640px", fig.cap="(ref:SPSSchisqcross)", dev="png", screenshot.opts = list(delay = 5)}
