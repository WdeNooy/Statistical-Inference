...
```{r mean-centering-plot, eval=TRUE, echo=FALSE, fig.pos='H', fig.align='center', fig.cap="Histograms of the original contacts with smokers variable and the mean-centered variable. The red lines represent the means."}
#create dataframe
set.seed(4932)
...
```{r cont-moderator-support, echo=FALSE, message=FALSE, warning=FALSE, fig.pos='H', fig.align='center', fig.cap="Common support of the predictor variable (exposure) at three levels of the moderator variable (contact)."}
