...
```{block2, type='rmdquestion'}
6. Check the **Show the mean-centered line** box in Figure \@ref(fig:mean-centering-moderator). A red regression line and equation appear that represent the effect of exposure on attitude if the moderator variable contact is mean-centered and zero (as indicated between brackets in the red equation). What is the simple regression equation for the effect of exposure on attitude here? [<img src="icons/2answer.png" width=115px align="right">](#answer9.1.6)
```
