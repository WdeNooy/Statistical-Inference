...
```{r se-point-est, fig.pos='H', fig.align='center', fig.cap="The standard error: How wrong are point estimates?", echo=FALSE, out.width="775px", screenshot.opts = list(delay = 5), dev="png"}
