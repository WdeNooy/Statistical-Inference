...
```{block2, type='rmdquestion'}
2. If you find the highest or lowest value of the population mean for which the sample mean is in the interval of sample means that have 95% probability to occur, a horizontal arrow appears with the label: 1.96 * SE.  
...
```{block2, type='rmdquestion'}
6. Does the (first) confidence interval include the true average candy weight in the population? [<img src="icons/2answer.png" width=115px align="right">](#answer3.5.6)
```

<A name="question3.5.7"></A>
```{block2, type='rmdquestion'}
7. Why is the point estimate (dot) exactly in the middle of each confidence interval? [<img src="icons/2answer.png" width=115px align="right">](#answer3.5.7)
```

<A name="question3.5.8"></A>
```{block2, type='rmdquestion'}
8. If you would draw a hundred random samples from the same population and calculate the 95% confidence interval for the mean of each sample, how many confidence intervals will contain the true population mean? Press the __New Sample__ button until there are one hundred confidence intervals. Does your expectation come true? If not, why not? [<img src="icons/2answer.png" width=115px align="right">](#answer3.5.8)
```
...
population mean than not. [<img src="icons/2question.png" width=161px align="right">](#question3.5.6)
```
...
of the confidence interval. [<img src="icons/2question.png" width=161px align="right">](#question3.5.7)
```

<A name="answer3.5.8"></A>
```{block2, type='rmdanswer'}
...
(slightly) larger or smaller than five. [<img src="icons/2question.png" width=161px align="right">](#question3.5.8)
```
