...
average candy weight per sample bag). This is indeed the initial value on the
slider. [<img src="icons/2question.png" width=161px align="right">](#question3.4.1)
```
...
Average weight of candies in the population is between 2.79 and   
2.88 gram with 95% confidence and between 2.77 and 2.90 gram  
with 99% confidence.  
If we want to be more confident, we must allow for a broader  
range of values, so the confidence interval is wider.  [<img src="icons/2question.png" width=161px align="right">](#question3.6.1)
```
...
Median candy weight in the sample is 2.81 gram. With   
95% confidence, we expect median candy weight to be   
between 2.77 and 2.92 grams in the population of all candies. 
The 95% interval borders can be slightly different because
bootstrapping takes random samples. [<img src="icons/2question.png" width=161px align="right">](#question3.6.2)
```
...
1.59 to 2.17) points in the data. This change is statistically   
significant, t (49) = 12.86, p < 001, 95%CI[1.59; 2.17]. [<img src="icons/2question.png" width=161px align="right">](#question3.6.3)
```
...
colourfulness decreases by 0.19 to 0.46 for  
...
effect can be negative (up to a 1.15 decrease for  
each additional candy weight gram with 95% confidence)
or positive (up to a 2.28 increase for each additional
candy weight gram with 95% confidence). [<img src="icons/2question.png" width=161px align="right">](#question3.6.4)
```
