...
```{block2, type='rmdquestion'}
1. How do you think the precision (width) of the interval estimate (represented by the double-sided arrow) changes if you change the confidence level?
...
Figure \@ref(fig:interval-size) shows a sampling distribution of average candy weight in candy sample bags. The size of the horizontal arrow represents the precision of the interval estimate: the smaller the arrow, the more precise the interval estimate.
