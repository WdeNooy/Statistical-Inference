...
```{r exactapproachfigure, eval=TRUE, echo=FALSE, fig.cap="Probabilities of a sample with a particular number of yellow candies if 20% of the candies are yellow in the population."}
knitr::include_graphics("exactapproach.png")
```
