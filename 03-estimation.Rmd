...
```{r eval=FALSE}
* The sampling distribution becomes more peaked/less flat because more sample
...
```{r exactapproachfigure, eval=TRUE, echo=FALSE, out.width="420px", fig.cap="Probabilities of a sample with a particular number of yellow candies if 20 per cent of the candies are yellow in the population."}
