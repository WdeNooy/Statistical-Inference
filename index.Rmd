...
# Chunks with answers to exercises have the echo option not set, so their visibility depends on the the echo option set for all chunks here. Set it to TRUE if the answers are always visible.
...
# Show TYU answers per chapter. Change between TRUE and FALSE.
ch1 <- TRUE
ch2 <- TRUE
ch3 <- FALSE
ch4 <- FALSE
