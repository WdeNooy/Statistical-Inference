...
```{r eval=FALSE}
1. The blue regression line in the top graph represents the predicted 
...
```{r eval=FALSE}
2. If the association between two variables is U-shaped, the regression
...
```{r, eval=FALSE}
1. The residuals are higher for higher values of exposure.
