...
1. Use the data in <a href="http://82.196.4.233:3838/data/smokers.sav" target="_blank">smokers.sav</a> to predict the attitude towards smoking from exposure, smoking status (variable _status3_), and contact with smokers. Check the assumptions and interpret the results.
...
```{r eval=FALSE}
The analysis method you choose, depends on your substantive decision 
on the direction of the association. 
If you assume no direction, a correlation coefficient is the most 
appropriate choice.
If you think one variable may depend on another, a (simple) regression 
...
5. Check common support of the predictor for the three values of the moderator that you have used in Exercises 3 and 4.
