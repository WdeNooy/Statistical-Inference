...
2. The line for a simple regression of attitude on exposure (without covariates) is displayed in grey in Figure \@ref(fig:regression-predict). Can you fit the original (multiple) regression line to the simple regression line? If so, at what covariate values? If not, why not?
